    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="Niveau.jsp">Gestion des niveaux</a></li>
                    <li class="nav-item"> <a class="nav-link" href="Categorie.jsp">Gestion des categories</a></li>
                    
                    <li class="nav-item"> <a class="nav-link" href="Matiere.jsp">Gestion des Matieres</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" href="Template/pages/forms/basic_elements.html">
                <span class="menu-title">Gestion des niveaux</span>
