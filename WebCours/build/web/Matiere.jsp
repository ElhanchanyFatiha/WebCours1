...
<%@page import="Beans.Matiere"%>
<%@page import="Service.MatiereService"%>
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Ajouter une Matiere</h4>
                                    ...
                                    <form class="forms-sample">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nom" name="nom" placeholder="Libelle">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">Categorie :</label>
                                            <select class="form-control" id="categorie" placeholder="Categorie">
                                                <option value="hidden" >Choisir une Categorie </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="niveau" name="niveau">
                                                <option value="hidden" >Choisir une Niveau </option>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody id="container">
                                            ...
                                            <tr>
                                                ...
                                                <td><%= m.getNiveau().getLibelle()%></td>

                                                <td><%= m.getCategorie().getLibelle()%></td>

                                                <td><button id="delete" class="btn btn-outline-danger btn-fw" v="<%= m.getId()%>">Supprimer</button></td>
                                                <td><button id="update" class="btn btn-outline-success btn-fw" v="<%= m.getId()%>">Modifier</button></td>
                                            </tr>
                                            <% }%>
                                        </tbody>
                                    </table>
